...
{
    public abstract class ManarWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ManarWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ManarWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ManarDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ManarDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ManarDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ManarDbContext, Task<T>> func)
        {
            T result;
