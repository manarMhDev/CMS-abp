...
@Injectable()
export class ServicesAppCrudServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    create(body: CreateServiceDto | undefined): Observable<ServiceDto> {
        let url_ = this.baseUrl + "/api/services/app/ServicesAppCrud/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<ServiceDto> {
        let url_ = this.baseUrl + "/api/services/app/ServicesAppCrud/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<ServiceDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getAll(slug: string | undefined, keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ServiceDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/ServicesAppCrud/GetAll?";
        if (slug === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ServiceDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ServiceDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ServiceDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ServiceDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    update(body: CreateServiceDto | undefined): Observable<ServiceDto> {
        let url_ = this.baseUrl + "/api/services/app/ServicesAppCrud/Update";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ServicesAppCrud/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class CreateServiceDto implements ICreateServiceDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["translations"])) {
                this.translations = [] as any;
                for (let item of _data["translations"])
                    this.translations.push(ServiceTranslationDto.fromJS(item));
            }
            ...
            this.gallery = _data["gallery"] ? GalleryDto.fromJS(_data["gallery"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["gallery"] = this.gallery ? this.gallery.toJSON() : <any>undefined;
        return data;
    }
...
export class ServiceDto implements IServiceDto {
    ...
    gallery: GalleryDto;
    serviceTags: ServiceTagDto[] | undefined;
    translations: ServiceTranslationDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.gallery = _data["gallery"] ? GalleryDto.fromJS(_data["gallery"]) : <any>undefined;
            if (Array.isArray(_data["serviceTags"])) {
                this.serviceTags = [] as any;
                for (let item of _data["serviceTags"])
                    this.serviceTags.push(ServiceTagDto.fromJS(item));
            }
            if (Array.isArray(_data["translations"])) {
                this.translations = [] as any;
                for (let item of _data["translations"])
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.serviceTags)) {
            data["serviceTags"] = [];
            for (let item of this.serviceTags)
                data["serviceTags"].push(item.toJSON());
        }
        if (Array.isArray(this.translations)) {
            data["translations"] = [];
            for (let item of this.translations)
...
export class ServiceTagDto implements IServiceTagDto {
    serviceId: number;
    tagId: number;
    tag: TagDto;

    constructor(data?: IServiceTagDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ServiceTagDto {
        data = typeof data === 'object' ? data : {};
        let result = new ServiceTagDto();
        result.init(data);
        return result;
    }
...
export interface IServiceTagDto {
    serviceId: number;
    tagId: number;
    tag: TagDto;
}

export class ServiceTranslationDto implements IServiceTranslationDto {
    title: string | undefined;
    content: string | undefined;
    description: string | undefined;
    metaTitle: string | undefined;
    metaKeywords: string | undefined;
    metaExcerpt: string | undefined;
    metaDescription: string | undefined;
    duration: string | undefined;
    language: string | undefined;

    constructor(data?: IServiceTranslationDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.metaExcerpt = _data["metaExcerpt"];
    ...
    static fromJS(data: any): ServiceTranslationDto {
        data = typeof data === 'object' ? data : {};
        let result = new ServiceTranslationDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["metaExcerpt"] = this.metaExcerpt;
...
export interface IServiceTranslationDto {
    title: string | undefined;
    content: string | undefined;
    description: string | undefined;
    metaTitle: string | undefined;
...
export class TagDto implements ITagDto {
    id: number;
    slug: string | undefined;
    translations: TagTranslationDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["translations"])) {
                this.translations = [] as any;
                for (let item of _data["translations"])
                    this.translations.push(TagTranslationDto.fromJS(item));
            }
        }
    }
...
export class TagTranslationDto implements ITagTranslationDto {
    name: string | undefined;
    language: string | undefined;

    constructor(data?: ITagTranslationDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TagTranslationDto {
        data = typeof data === 'object' ? data : {};
        let result = new TagTranslationDto();
        result.init(data);
        return result;
    }
...
export interface ITagTranslationDto {
    name: string | undefined;
    language: string | undefined;
}
